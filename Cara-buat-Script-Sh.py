...
def main (kata):
        for e in kata:
            ...
            time.sleep(0.2)
print ("""
\033[1;91m    ____   ____ ____  ___ ____ _____ 
   / ___| / ___|  _ \|_ _|  _ \_   _|
   \___ \| |   | |_) || || |_) || |  
\033[1;37m    ___) | |___|  _ < | ||  __/ | |  
...
""")
main("""
\033[1;37m#Cara-Buat-Script.Shell
clear
logo nya buat sendiri ya gaess :v
echo "[======================================]"
echo "[01] : Seterah kalian"
echo "[02] : Seterah kalian"
echo "[03] : Seterah kalian"
echo "[04] : Seterah kalian"
echo "[05] : Seterah kalian"
echo "[06] : Seterah kalian"
echo "[07] : Seterah kalian"
echo "[08] : Seterah kalian"
echo "[09] : Seterah kalian"
echo "[10] : Seterah kalian"
echo "[00] : Exit"
echo "[======================================]"
""")
time.sleep(4)
os.system("python3 Cara-buat-Script-Sh.py")
